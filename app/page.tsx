...
export default function Home() {
  ...
  const paragraphs = [
    ...
    "With a depth of knowledge in contemporary design, e-commerce, and frontend engineering, we evaluate each project's specific needs and craft solutions, turning ideas into impactful experiences.",
  ];
        ...
        <main className="animate-fade-in-slower-delay opacity-0 pt-16 xl:pt-36 min-h-[92vh]">
          <div className="grid grid-cols-[50%_50%] lg:grid-cols-[25%_25%_30%_auto_max-content] h-max mt-12 mb-12">
            <div className="col-span-2 lg:col-span-1 lg:row-span-2 mb-16 lg:mb-0 text-xs w-5/6 lg:max-w-64 italic">
              ...
              <p>Interested in working together? Say <a target="_blank" href="mailto:hello@jnpr.studio">hello@jnpr.studio</a></p>
            </div>
