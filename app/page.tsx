...
const projects = [
  ...
  },
  {
    ...
    description: [
      "Owned all aspects of the Faces of Another e-commerce website; continually  collaborating with partners on design updates and new features, as well as analyzing analytics insights."
    ],
    stackTags: {
      cms: "Sanity",
      commerce: "Shopify",
