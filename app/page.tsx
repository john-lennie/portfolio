  ...
  return (
    <div>
      <div className="min-h-screen bg-white text-black">
        ...
        <main className="animate-fade-in-slow-delay opacity-0 px-4 md:px-12 lg:px-36 py-48 lg:py-36">
          <div className="w-full md:w-1/2">
            <h1 className="mb-12">Juniper is a digital product studio specializing in the design and development of ecommerce and digital experiences for global companies, local businesses, creative studios and artists.</h1>
